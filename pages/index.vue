<template>
  <div class="tab">
    ...
    <div class="t-n">
      <ul class="t-u">
        <li  @click="tabClicks(1)" :class="{active:isActives===1}" >我关注的</li>
        <li  @click="tabClicks(2)" :class="{active:isActives===2}" >Android</li>
        <li  @click="tabClicks(3)" :class="{active:isActives===3}" >前端</li>
        <li  @click="tabClicks(4)" :class="{active:isActives===4}" >iOS</li>
        <li  @click="tabClicks(5)" :class="{active:isActives===5}" >后端</li>
        <li  @click="tabClicks(6)" :class="{active:isActives===6}" >设计</li>
        <li  @click="tabClicks(7)" :class="{active:isActives===7}" >产品</li>
        <li  @click="tabClicks(8)" :class="{active:isActives===8}" >工具资源</li>
        <li  @click="tabClicks(9)" :class="{active:isActives===9}" >阅读</li>
        <li  @click="tabClicks(10)" :class="{active:isActives===10}" >人工智能</li>
      </ul>
    ...
    <div class="t-z">
      ...
      <div class="t-wrapper">
        ...
        <div class="t-header">
          <ul class="t-w">
            <li class="t-i"></li>
            <li><img src="~assets/images/write.svg" alt=""><a href="">写文章</a></li>
            <li><img src="~assets/images/share.svg" alt=""><a href="">分享链接</a></li>
          </ul>
        ...
        <div class="t-r">
          <ul class="t-ul1">
            <li  @click="tabClick(1)" :class="{active:isActive===1}">热门</li>
            <li>|</li>
            <li    @click="tabClick(2)" :class="{active:isActive===2}">最新</li>
            <li>|</li>
            <li   @click="tabClick(3)" :class="{active:isActive===3}">评论</li>
          </ul>
          <ul class="t-ul2">
            <li  @click="tabClick(4)" :class="{active:isActive===4}" >本周最热</li>
            <li>.</li>
            <li  @click="tabClick(5)" :class="{active:isActive===5}" >本月最热</li>
            <li>.</li>
            <li  @click="tabClick(6)" :class="{active:isActive===6}" >历史最热</li>
          </ul>
        </div>
        <list-card v-for="(item, index) in list" :key="index" :content="item"></list-card>
      </div>
      <!-- 右侧边栏 -->
      <div class="t-menu">
        <!-- 二维码 -->
...
import listCard from '~/components/card/card.vue'
export default {
  data () {
    return {
      isActive: 1,
